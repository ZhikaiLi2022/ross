...
for ii in range(len(IDdir)):
    ...
    cha, min_time1, min_time2,bian = difference(mu)#差分寻峰结果
    ...
    try:
        ...
        for i in bian:
            plt.axvline(X_new[i],c='r',ls='--',lw=1)
        ...
        plt.legend()
        plt.show()
        min_time1 = int(input("min_time1:"))
        min_time2 = int(input("min_time2:"))
        star1_p = int(input("star1:"))
        end1_p  = int(input("end1:"))
        star2_p = int(input("star2:"))
        end2_p  = int(input("end2:"))
        ...
        plt.savefig("/home/life/双星偏心率的求解/e_data_picture1/"+lc.label+".png")
    except:
